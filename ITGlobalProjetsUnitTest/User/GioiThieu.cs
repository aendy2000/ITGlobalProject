...
namespace ITGlobalProjetsUnitTest.User.Controller
{
    ...
    {
        GioiThieuController gioithieu = new GioiThieuController();
        ...
        public void ViewIndex()
        {
            ...
            gioithieu.ControllerContext = mockControllerContext.Object;

            ViewResult result = gioithieu.Index() as ViewResult;
