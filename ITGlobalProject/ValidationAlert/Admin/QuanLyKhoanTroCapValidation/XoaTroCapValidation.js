            ...
            var initDemos = function () {
                swal({
                    ...
                    if (xoavaitro) {
                        ...
                        $.ajax({
                            url: $('#requestPath').val() + "Admins/QuanLyTroCapVaPhuCap/xoaTroCapVaPhuCap",
                            type: 'POST',
                            dataType: 'html',
                            contentType: false,
                            processData: false,
                            ...
                            if (ketqua === "DANHSACH") {
                                ...
                                var SweetAlert2Demo = function () {
                                    var initDemos = function () {
                                        swal("Thành Công!", "Tuyệt quá! Một khoản trợ cấp đã được xóa thành công.", {
                                            icon: "success",
                                            buttons: {
                                                confirm: {
                                                    className: 'btn btn-success'
