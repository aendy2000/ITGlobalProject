$(document).ready(function (e) {
    ...
    $('#luuChinhSua').on('click', function (e) {
        ...
        if (name.length == 0) {
            ...
            checkname = false;
            $('#EditDanhMucKyNangValidateResul').text("Nhập không đúng định dạng! Vui lòng kiểm tra lại.").show();
        } else if (name.length > 50) {
            checkname = false;
            $('#EditDanhMucKyNangValidateResul').text("Nhập quá giới hạn ký tự! Vui lòng kiểm tra lại.").show();
        }
