$(document).ready(function () {
    ...
    $('#luuChinhSua').on('click', function (e) {
        ...
        if (checkshoten === true && checkscmnd === true && checkssodienthoai === true && checksngaysinh === true &&
            checksgioitinh === true && checksvaitro === true && checksdiachiemail === true) {
            e.preventDefault();
            ...
            formData.append('vaitros', vaitro);
            formData.append('nguoiphuthuocs', nguoiphuthuoc);
            formData.append('mucluongs', mucluong);
            formData.append('dsNganHangs', dsNganHang);
