...
! function (t, e) {
    ...
    var C = {
        name: "en",
        options: {
            months: ["Tháng M?t", "Tháng Hai", "Tháng Ba", "Tháng B?n", "Tháng Năm", "Tháng Sáu", "Tháng B?y", "Tháng Tám", "Tháng Chín", "Tháng Mư?i", "Tháng Mư?i M?t", "Tháng Mư?i Hai"],
            shortMonths: ["Th 1", "Th 2", "Th 3", "Th 4", "Th 5", "Th 6", "Th 7", "Th 8", "Th 9", "Th 10", "Th 11", "Th 12"],
            days: ["Ch? Nh?t", "Th? Hai", "Th? Ba", "Th? Tư", "Th? Năm", "Th? Sáu", "Th? B?y"],
            shortDays: ["CN", "T2", "T3", "T4", "T5", "T6", "T7"],
            toolbar: {
                exportToSVG: "T?i xu?ng SVG",
                exportToPNG: "T?i xu?ng PNG",
                exportToCSV: "T?i xu?ng CSV",
                menu: "Menu",
                selection: "Selection",
